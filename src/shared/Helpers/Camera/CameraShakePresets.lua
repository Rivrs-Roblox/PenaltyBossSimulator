...
local CameraShakePresets = {
	...
	-- Should happen once.
	Bump = function()
		local c = CameraShakeInstance.new(2.5, 5, 0.1, 0.5)
	...
	Shoot = function()
		local c = CameraShakeInstance.new(2.5, 5, 0.1, 0.8)
		c.PositionInfluence = Vector3.new(0.05, 0.05, 0.05)
		c.RotationInfluence = Vector3.new(0.5, 0.25, 0.25)
		return c
	end,

	GoalieDefend = function()
		local c = CameraShakeInstance.new(0.4, 15, 0.1, 1.2)
		c.PositionInfluence = Vector3.new(0, 0.15, 0)
		c.RotationInfluence = Vector3.new(1.25, 0, 4)
		return c
	end,

	GoalieDefendSpecial = function()
		local c = CameraShakeInstance.new(0.4, 20, 0.2, 1)
		c.PositionInfluence = Vector3.new(0, 0.15, 0)
		c.RotationInfluence = Vector3.new(1.25, 0, 4)
		return c
	end,
	...
	Goal = function()
		local c = CameraShakeInstance.new(2, 4, 0.1, 0.8)
		c.PositionInfluence = Vector3.new(0.05, 0.05, 0.05)
		c.RotationInfluence = Vector3.new(0.5, 0.25, 0.25)
		return c
	end,
	...
	-- A sharp, impactful shake for collision (hit by something).
	-- Should happen once.
	Hit = function()
		local c = CameraShakeInstance.new(4, 7, 0.2, 1)
