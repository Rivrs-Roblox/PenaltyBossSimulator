...
function Data:Init()
	...
	DataService:GetData():andThen(function(data)
		...
		Store:dispatch(PlayerActions.setVerified(data.Codes.Verified))
	...
	CodesService.PlayerVerified:Connect(function(verified: boolean)
		Store:dispatch(ChestsActions.setVerified(verified))
		Store:dispatch(PlayerActions.setVerified(verified))
	end)
