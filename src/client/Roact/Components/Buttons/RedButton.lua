...
return function(params: table)
    ...
    return Roact.createElement("ImageButton", {
        ...
        Text = Text({ text = params.text, color = Color3.fromRGB(255, 255, 255), backgroundTransparency = 1, position = UDim2.fromScale(0.5, 0.5), size = UDim2.fromScale(0.9, 0.5), stroke = 2 })
    })
end