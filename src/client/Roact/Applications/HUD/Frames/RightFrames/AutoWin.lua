...
function AutoWin(_, hooks)
	...
	return Roact.createElement("Frame", {
		...
		Position = UDim2.fromScale(0.162, 0.73),
		...
		AutoWin = Roact.createElement("ImageButton", {
			...
			ImageColor3 = if AutoReducer.AutoWinning == true
				then Color3.fromRGB(111, 255, 0)
				else Color3.fromRGB(255, 51, 0),
			...
			Icon = Image({
				image = UI.Wins,
				position = UDim2.fromScale(0.049, 0.482),
				size = UDim2.fromScale(0.284, 1.036),
				backgroundTransparency = 1,
				children = {
					UIAspectRatioConstraint = Roact.createElement("UIAspectRatioConstraint", {
						AspectRatio = 1,
			...
			Title = Text({
				...
				size = UDim2.fromScale(0.494, 0.441),
				stroke = 1.5,
				color = Color3.fromRGB(255, 255, 255),
			}),
			Free = Text({
				text = "FREE!",
				position = UDim2.fromScale(0.832, 0.137),
				size = UDim2.fromScale(0.221, 0.441),
				stroke = 1.5,
				color = Color3.fromRGB(255, 255, 255),
			}),
		}),
...
AutoWin = RoactHooks.new(Roact)(AutoWin)
return AutoWin
