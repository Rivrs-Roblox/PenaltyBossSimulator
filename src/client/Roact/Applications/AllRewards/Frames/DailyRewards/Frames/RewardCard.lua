...
return function(params, hooks)
	...
	local size = params.size or (weekDay == 7 and UDim2.fromScale(0.28, 1) or UDim2.fromScale(0.3, 0.45))
	...
	return Roact.createElement("Frame", {
		...
		TouchTarget = Roact.createElement("ImageButton", {
			...
			[Roact.Event.MouseButton1Click] = handleClaim,
		}),
		...
		AmountText = Roact.createElement("TextLabel", {
			...
			TextColor3 = weekDay == 7 and Color3.fromHex("ffffff") or theme.text,
			TextScaled = true,
			TextWrapped = true,
			ZIndex = 4,
		}, {
