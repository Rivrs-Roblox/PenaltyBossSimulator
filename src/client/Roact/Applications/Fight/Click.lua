...
function Click(_, hooks)
	...
	-- 	local function onStartFaceTarget()
	-- 		setVisible(true)
	-- 	end

	-- 	-- Event listener untuk menyembunyikan frame
	-- 	local function onStopFaceTarget()
	-- 		setVisible(false)
	-- 	end

	-- 	-- Sambungkan event
	-- 	local startConnection = FightService.Client.FightStarted:Connect(onStartFaceTarget)
	-- 	local stopConnection = FightService.Client.FightEnded:Connect(onStopFaceTarget)
	...
	hooks.useEffect(function()
		...
		-- Support untuk Console (X di Gamepad)
		-- ContextActionService:BindActionAtPriority("ClickAction", function(_, state)
	...
	return Roact.createElement("Frame", {
		...
		Position = UDim2.fromScale(1.275, -4.4),
		Size = UDim2.fromScale(2, 2),
		ZIndex = 1,
		LayoutOrder = 4,
		Visible = fightReducer.Fighting, -- State visibilitas dikontrol oleh event
	}, {
